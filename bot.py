...
async def on_ready():
    ...
    await client.change_presence(activity=discord.Game(name='.vstatus | EmailVerify'))
...
keep_alive()
client.run(os.environ.get('ODkyODEwNjc2MzIwNDk3Njk1.YVSUvA._uoAqDHgdwYRpIpqYSlMsmgPDMQ'))
